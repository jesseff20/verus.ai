...
import { Loader2, FileText, Link as LinkIcon, AlertCircle, CheckCircle, Info } from 'lucide-react';
...
export function CreateTemplateDialog({ children, onSuccess }: CreateTemplateDialogProps) {
  ...
  const renderInfoTab = () => (
    <TabsContent value="info" className="space-y-4">
      <Alert>
        ...
        <AlertDescription>
          Defina as informações básicas do template. Você poderá criar o conteúdo na próxima aba.
        </AlertDescription>
      </Alert>
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription className="sr-only">Criar novo template de documento com conteúdo e vinculação de formulário</DialogDescription>
        </DialogHeader>
