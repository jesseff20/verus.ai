...
export default function EditTemplatePage() {
  ...
  const { data: template, isLoading } = useTemplate(templateId, true);
  ...
  // Carrega dados do template quando retornar
  useEffect(() => {
    if (template) {
      setFormData({
        name: template.name,
      ...
      const content = template.rendered_content || template.content || '';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await updateTemplate({ id: templateId, data: payload });
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Edite o template de documento com editor visual
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Edite os dados e conteúdo do template</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <Alert>
              ...
              <AlertDescription>
                Use o editor abaixo para editar o conteúdo do template. Você pode colar do Word, inserir imagens e adicionar placeholders no formato <code className="bg-slate-200 dark:bg-slate-800 px-1 rounded">{'{{nome_campo}}'}</code>
              </AlertDescription>
            </Alert>
