...
USERS_DATA = [
    ...
    },
    {
        ...
        'oab_state': 'SP',
        'phone': '(11) 98765-4321',
        'lawyer_specialties': ['Cível', 'Empresarial', 'Tributário'],
    },
    {
        ...
        'oab_state': 'SP',
        'phone': '(11) 97654-3210',
        'lawyer_specialties': ['Trabalhista', 'Família'],
    },
    {
        'username': 'pedro.lima',
        ...
        'oab_state': 'RJ',
        'phone': '(21) 96543-2109',
        'lawyer_specialties': ['Criminal', 'Consumidor'],
    },
    {
        'username': 'ana.costa',
...
CLIENTS_DATA = [
    # --- Pessoa Física ---
    {
        ...
        'state': 'SP',
        'zipcode': '01234-567',
        'notes': 'Cliente desde 2024. Processo cível de indenização em andamento.',
    },
    {
        'name': 'Fernanda Cristina Barbosa',
        'client_type': 'pessoa_fisica',
        'cpf_cnpj': '782.453.196-80',
        'rg': '34.567.890-X',
        'email': 'fernanda.barbosa@email.com',
        'phone': '(21) 98765-1234',
        'address': 'Av. Atlântica, 456, Bl A',
        'city': 'Rio de Janeiro',
        'state': 'RJ',
        'zipcode': '22010-000',
        'notes': 'Reclamação trabalhista contra ex-empregador.',
    },
    {
        'name': 'Roberto Mendes da Silva',
        'client_type': 'pessoa_fisica',
        'cpf_cnpj': '523.891.704-62',
        'rg': '45.678.901-2',
        ...
        'state': 'MG',
        'zipcode': '30160-011',
        'notes': 'Divórcio consensual com partilha de bens e guarda compartilhada.',
    },
    {
        'name': 'Luciana Ferreira Gomes',
        'client_type': 'pessoa_fisica',
        'cpf_cnpj': '196.745.832-19',
        'rg': '56.789.012-5',
        ...
        'state': 'PR',
        'zipcode': '80020-310',
        'notes': 'Defesa em processo criminal. Réu primário.',
    },
    {
        ...
        'state': 'RS',
        'zipcode': '90020-025',
        'notes': 'Ação de cobrança indevida contra operadora de telefonia.',
    },
    # --- Pessoa Jurídica ---
    {
        ...
        'notes': 'Contrato de assessoria jurídica permanente. Foco em direito empresarial.',
    },
    {
        ...
        'phone': '(41) 3210-9876',
        'address': 'Rua Marechal Deodoro, 500, Sala 801',
        'city': 'Curitiba',
        'state': 'PR',
        'zipcode': '80020-320',
    ...
    },
    {
        ...
        'contact_person': 'Paulo Henrique (Gerente Financeiro)',
        'notes': 'Contencioso tributário — ISS e ICMS. Assessoria em contratos de distribuição.',
    },
]
