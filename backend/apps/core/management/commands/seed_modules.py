...
MODULES_DATA = [
    ...
    },
    {
        ...
        'description': 'Geração de peças jurídicas e pareceres com IA',
        'icon': 'Bot',
    ...
    },
    {
        'key': 'copilot',
        'name': 'Copiloto',
        'description': 'Assistente de IA para procuradores',
        'icon': 'Sparkles',
    ...
    {
        'key': 'partes',
        'name': 'Partes / Interessados',
        'description': 'Gestão de partes, entes públicos e interessados nos processos',
        'icon': 'Users',
        'route': '/dashboard/partes',
        'permission_codename': 'can_access_partes',
        'display_order': 10,
    },
    {
        'key': 'normativas',
        'name': 'Normativas',
        'description': 'Portarias, resoluções, decretos e atos normativos internos',
        'icon': 'BookOpen',
        'route': '/dashboard/normativas',
        'permission_codename': 'can_access_normativas',
        'display_order': 11,
    },
    {
        'key': 'contratos_administrativos',
        'name': 'Contratos Administrativos',
        'description': 'Gestão de contratos administrativos, convênios e termos aditivos',
        'icon': 'FileSignature',
        'route': '/dashboard/contratos-administrativos',
        'permission_codename': 'can_access_contratos_administrativos',
        'display_order': 12,
    },
    {
        'key': 'licitacoes',
        'name': 'Licitações',
        'description': 'Acompanhamento e assessoria jurídica em processos licitatórios',
        'icon': 'Gavel',
        'route': '/dashboard/licitacoes',
        'permission_codename': 'can_access_licitacoes',
        'display_order': 13,
    },
    {
        'key': 'convenios',
        'name': 'Convênios',
        'description': 'Gestão de convênios, termos de cooperação e instrumentos congêneres',
        'icon': 'Handshake',
        'route': '/dashboard/convenios',
        'permission_codename': 'can_access_convenios',
        'display_order': 14,
    },
]
